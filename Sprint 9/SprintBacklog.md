...
| US-38 | **Lista čekanja za termine** — Kao pacijent, želim se prijaviti na listu čekanja za popunjene kabinete, kako bih automatski dobio ponudu za slobodan termin u slučaju otkazivanja. | Amina Alispahić | Done | Kreiranje tabele `waiting_lists`; event-driven servis sa TTL tajmerom od 30 min; automatska eskalacija na sljedećeg korisnika |
