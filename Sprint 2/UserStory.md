...
| ID | Naziv  | Opis | Poslovna Vrijednost | Prioritet | Pretpostavke | Otvorena Pitanja | Veze / Zavisnosti |
|----|-------------|------|---------------------|-----------|--------------|------------------|-------------------|
...
| US-02 | Upravljanje sistemskim resursima | Kao administrator, želim da imam korisnički interfejs za administraciju, kako bih mogao upravljati korisnicima, terminima i resursima. | Jednostavno praćenje i upravljanje aktivnostima uz primjenu sistema kontrolisanih pristupnih prava | Visok | -Administrator ima kreiran i aktivan korisnički nalog u sistemu-Sistem podržava definisane korisničke uloge-Baza podataka sadrži osnovne entitete (korisnici, termini, resursi) -Administrator ima ovlašten pristup svim administrativnim funkcijama -Backend servis za upravljanje podacima je dostupan i funkcionalan | - Koje tačno funkcionalnosti su uključene u administrativni interfejs? | US-03, US-04, US-16, US-29 |
