...
| — | **Integraciono testiranje panela i role-based toka** — Tehnički zadatak: Funkcionalno i integraciono testiranje svih implementiranih panela i kompletnog toka login → uloga → panel za uloge korisnika. | Sumeja Mušić, Almedin Šehić | Done | Testiranje mora početi najkasnije sredinom sprinta; verifikacija da nijedna uloga nema pristup resursima koji nisu u njenoj nadležnosti (NFR-06, NFR-07) |
