...
export function mapirajRezervaciju(r: any): Termin {
  ...
  return {
    ...
    pacijent: {
      ...
      alergije: r.pacijent.alergije ?? null,
      hronicneBolesti: r.pacijent.hronicneBolesti ?? null,
      krvnaGrupa: r.pacijent.krvnaGrupa ?? null,
      doniraKrv: r.pacijent.doniraKrv ?? false,
      imaoOperacije: r.pacijent.imaoOperacije ?? false,
      operacijeOpis: r.pacijent.operacijeOpis ?? null,
    },
    tip,
    status,
    komentari,
