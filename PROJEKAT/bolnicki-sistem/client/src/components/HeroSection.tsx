  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0">
        <img
          src="https://images.pexels.com/photos/7581382/pexels-photo-7581382.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="animate-fade-in delay-300 flex flex-wrap gap-4">
              <Link to="/rezervacija-pacijent" className="cta-button flex items-center gap-2.5 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-7 py-3.5 rounded-xl shadow-lg no-underline">
