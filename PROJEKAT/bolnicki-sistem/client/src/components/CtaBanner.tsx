    ...
    <section className="py-20 bg-gradient-to-r from-blue-800 via-blue-700 to-sky-600 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button className="cta-button inline-flex items-center justify-center gap-2.5 bg-white text-blue-800 font-bold px-8 py-3.5 rounded-xl shadow-lg hover:bg-blue-50">
            <CalendarCheck className="w-5 h-5" />
            Zakažite odmah
            <ArrowRight className="w-4 h-4" />
          </button>
          <button className="cta-button inline-flex items-center justify-center gap-2.5 border-2 border-white/40 text-white font-semibold px-8 py-3.5 rounded-xl hover:bg-white/10 transition-all duration-200">
            Saznajte više
          </button>
        </div>
      </div>
