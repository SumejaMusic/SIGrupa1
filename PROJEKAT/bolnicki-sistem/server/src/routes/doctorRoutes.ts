...
import { getReviewsZaDoktora } from "../controllers/reviewController.js";
...
router.get("/:id/reviews", autentifikuj, autorizacija(["DOKTOR", "ADMINISTRATOR", "VLASNIK"]), getReviewsZaDoktora);
