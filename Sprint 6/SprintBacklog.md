...
| US-31 | **Automatski podsjetnik za pacijente sa hroničnim bolestima** — Kao pacijent sa hroničnim oboljenjem, želim da primim automatski email podsjetnik o nadolazećem terminu, kako bih blagovremeno obavio kontrolni pregled. | Sumeja Mušić | To Do | Nodemailer + planirani scheduler, implementacija se nastavlja nakon završetka autentifikacije korisnika|
